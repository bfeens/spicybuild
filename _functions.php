...
<?php
/**
 * spicy functions and definitions
 *
 * @package spicy
 */
...
function spicy_setup() {
	 ...
	 * If you're building a theme based on spicy, use a find and replace
	 * to change 'spicy' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'spicy', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( 'spicy_custom_background_args', array(
 ...
 */
function spicy_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'spicy_content_width', 640 );
}
add_action( 'after_setup_theme', 'spicy_content_width', 0 );
...
function spicy_scripts() {
	...
	wp_enqueue_style( 'spicy-style', get_stylesheet_uri() . '/css/spicy.css', array(), '' , false );
